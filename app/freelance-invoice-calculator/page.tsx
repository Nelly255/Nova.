...
import { Download, Receipt, FileText, ArrowLeft, Moon, Sun, CheckCircle2, Circle, ArrowRight, Briefcase, Type, LayoutTemplate, Palette } from "lucide-react";

export default function PublicFreelanceCalculator() {
  // THEME STATE
  ...
  return (
    <div className="min-h-screen bg-[#F8F9FB] dark:bg-[#07070A] text-slate-900 dark:text-slate-50 transition-colors duration-500 relative overflow-hidden" style={{ fontFamily: "'Plus Jakarta Sans', 'Inter', sans-serif" }}>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "name": "Nova Freelance Invoice Calculator",
            ...
            "description": "Reverse engineer your freelance invoice. Calculate exact Gross amounts to cover 5% Withholding Tax (WHT) and 18% VAT in Tanzania to guarantee your target net take-home pay."
          })
        }}
      />
      ...
      <div className="absolute bottom-[-10%] left-[-5%] w-[500px] h-[500px] bg-indigo-500/5 dark:bg-indigo-500/10 rounded-full blur-[120px] pointer-events-none opacity-60 z-0 print:hidden"></div>

      <div className="relative z-10 pt-6 md:pt-12 px-4 sm:px-6 print:hidden">
        
        {/* TOP NAV */}
        <nav className="max-w-6xl mx-auto mb-8 md:mb-16 flex items-center justify-between">
          ...
          <div className="grid lg:grid-cols-2 gap-6 md:gap-8">
            ...
            <div className="group bg-[#8B5CF6]/5 dark:bg-[#8B5CF6]/10 p-6 sm:p-8 md:p-10 rounded-3xl md:rounded-[2.5rem] border border-[#8B5CF6]/20 backdrop-blur-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] flex flex-col justify-center">
              ...
              <div className="mt-auto grid grid-cols-1 sm:grid-cols-2 gap-3 w-full">
                ...
                >
                  Track Invoices <ArrowRight size={18} />
                </Link>
              </div>
      ...
      <div className={`hidden print:block w-full max-w-[210mm] min-h-[297mm] mx-auto bg-white text-slate-900 ${template !== 'modern' && 'print:hidden'}`}>
      ...
      <div className={`hidden print:block w-full max-w-[210mm] min-h-[297mm] mx-auto bg-white text-slate-900 ${template !== 'executive' && 'print:hidden'}`}>
        <div className="p-12 flex flex-col h-full">
      ...
      <div className={`hidden print:block w-full max-w-[210mm] min-h-[297mm] mx-auto bg-white text-slate-900 relative ${template !== 'minimal' && 'print:hidden'}`}>
      ...
      {/* Global Print Styles to force background colors in PDF and hide scrollbars */}
      <style jsx global>{`
        ...
        @media print {
          ...
          /* This removes browser margins and the dark grey background in the final output */
