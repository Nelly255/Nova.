      ...
      <div className="flex-1 flex items-center justify-center p-6 z-10">
        <div className="w-full max-w-md bg-white/90 dark:bg-slate-900/60 backdrop-blur-2xl border border-slate-200/50 dark:border-white/10 p-8 sm:p-10 rounded-[2.5rem] shadow-2xl dark:shadow-[0_20px_60px_-15px_rgba(0,0,0,0.5)] relative overflow-hidden">
          ...
          <div className="text-center mb-8">
            <div className="w-12 h-12 bg-brand-50 dark:bg-brand-500/20 rounded-2xl flex items-center justify-center mx-auto border border-brand-100 dark:border-brand-500/30 mb-4 text-brand-600 dark:text-brand-400">
              <Lock size={20} />
            </div>
          ...
          <form className="space-y-4" onSubmit={handleUpdatePassword}>
            ...
            <button 
              ...
              className="w-full flex justify-center items-center gap-2 bg-gradient-to-r from-brand-500 to-purple-600 hover:from-brand-400 hover:to-purple-500 text-white font-bold py-3.5 rounded-xl shadow-[0_8px_20px_-6px_rgb(var(--brand-500)/0.6)] hover:-translate-y-0.5 active:scale-95 transition-all mt-6 disabled:opacity-70 disabled:hover:translate-y-0"
            >
