...
import { ArrowLeft, Moon, Sun, ArrowRight, Home, TrendingDown, Briefcase, ShieldCheck } from "lucide-react";
...
export default function AssetTrackerPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F8F9FB] dark:bg-[#07070A] text-slate-900 dark:text-slate-50 transition-colors duration-500 relative overflow-hidden" style={{ fontFamily: "'Plus Jakarta Sans', 'Inter', sans-serif" }}>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": "Catalog your physical and digital assets. Track real estate, vehicles, and business equity with automated TRA depreciation in Tanzania."
          })
        }}
      />

      {/* AMBIENT GLOW (Top matches UI Purple, Bottom keeps a hint of Gold/Amber) */}
      ...
      <div className="absolute bottom-[-10%] left-[-5%] w-[500px] h-[500px] bg-[#F59E0B]/5 dark:bg-[#F59E0B]/10 rounded-full blur-[120px] pointer-events-none opacity-60 z-0"></div>
        ...
        <header className="max-w-6xl mx-auto mb-20 grid lg:grid-cols-2 gap-10 items-end">
          <div className="space-y-6">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-slate-100 dark:bg-[#12121A] border border-slate-200 dark:border-white/5 shadow-sm">
              ...
              <span className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-500 dark:text-slate-400">PORTFOLIO VAULT</span>
            </div>
          ...
          <div className="lg:pl-10 lg:border-l-2 border-slate-200 dark:border-white/10">
            <p className="text-lg sm:text-xl md:text-2xl font-medium text-slate-500 dark:text-slate-400 leading-tight mb-4">
              Catalog physical wealth <br />
              & <span className="text-slate-900 dark:text-white font-bold">Track Market Appreciations.</span>
            </p>
            <p className="text-xs sm:text-sm font-semibold text-slate-400 dark:text-slate-500 leading-relaxed max-w-md mb-8">
              Wealth in Tanzania is more than just a bank balance. Log your plots of land, commercial vehicles, equipment, and business equity in one definitive, encrypted portfolio.
            </p>
            ...
            <Link href="/login" className="inline-flex items-center justify-center gap-3 w-full sm:w-auto py-4 px-8 bg-[#8438FF] hover:bg-[#7328F5] text-white rounded-[1.5rem] font-bold text-[15px] shadow-[0_8px_20px_rgba(132,56,255,0.3)] transition-all duration-300 active:scale-95 group">
              Catalog My Assets <ArrowRight size={18} className="group-hover:translate-x-1 transition-transform" />
            </Link>
          </div>
        </header>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="md:col-span-2 group bg-white dark:bg-[#0F0F15]/80 p-8 md:p-10 rounded-3xl md:rounded-[2.5rem] border border-slate-100 dark:border-white/5 backdrop-blur-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:-translate-y-2 transition-transform duration-300">
              ...
              <p className="text-sm font-medium text-slate-500 dark:text-slate-400 leading-relaxed max-w-lg">
                Whether you own a finished apartment in Dar es Salaam or bare plots in Dodoma, track the appreciating market value of your real estate directly alongside your liquid cash.
              </p>
            </div>
            ...
            <div className="group bg-white dark:bg-[#0F0F15]/80 p-8 md:p-10 rounded-3xl md:rounded-[2.5rem] border border-slate-100 dark:border-white/5 backdrop-blur-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:-translate-y-2 transition-transform duration-300">
              ...
              <p className="text-sm font-medium text-slate-500 dark:text-slate-400 leading-relaxed">
                Log your vehicles, tech, and machinery. Nova automatically calculates their reducing balance using official TRA depreciation standards.
              </p>
            </div>
            ...
            <div className="group bg-white dark:bg-[#0F0F15]/80 p-8 md:p-10 rounded-3xl md:rounded-[2.5rem] border border-slate-100 dark:border-white/5 backdrop-blur-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:-translate-y-2 transition-transform duration-300">
              ...
              <p className="text-sm font-medium text-slate-500 dark:text-slate-400 leading-relaxed">
                Own a stake in a local startup, retail shop, or trading firm? Assign a market valuation to your private equity and watch it compound.
              </p>
            </div>
            ...
            <div className="md:col-span-2 group bg-white dark:bg-[#0F0F15]/80 p-8 md:p-10 rounded-3xl md:rounded-[2.5rem] border border-slate-100 dark:border-white/5 backdrop-blur-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:-translate-y-2 transition-transform duration-300">
              ...
              <h3 className="text-2xl font-black tracking-tight text-slate-900 dark:text-white mb-3">
                Feeds your Net Worth. Securely.
              </h3>
              <p className="text-sm font-medium text-slate-500 dark:text-slate-400 leading-relaxed max-w-lg">
                Every asset you log instantly syncs with your overarching Net Worth dashboard. Your portfolio details remain strictly confidential, encrypted directly to your personal Nova Vault.
              </p>
            </div>
