        ...
        <section className="max-w-6xl mx-auto pb-12">
          <div className="grid lg:grid-cols-2 gap-6 md:gap-8">
            ...
            <div className="group bg-rose-500/5 dark:bg-rose-500/10 p-8 md:p-10 rounded-3xl md:rounded-[2.5rem] border border-rose-500/20 backdrop-blur-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] flex flex-col justify-center">
              ...
              <Link href="/dashboard" className="mt-10 inline-flex items-center justify-center gap-3 w-full py-4 bg-rose-500 hover:bg-rose-600 text-white rounded-2xl font-bold shadow-[0_8px_20px_rgba(244,63,94,0.3)] transition-all active:scale-95">
