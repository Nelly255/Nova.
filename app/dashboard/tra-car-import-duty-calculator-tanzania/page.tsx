...
import { Download, Car, DollarSign, Activity, AlertCircle, Calendar, ChevronDown, Settings2, Info } from "lucide-react";

export default function DashboardImportCalculator() {
  // CALCULATOR STATE
  ...
  return (
    <div className="w-full bg-transparent text-slate-900 dark:text-slate-50 relative overflow-hidden print:bg-white print:text-black" style={{ fontFamily: "'Plus Jakarta Sans', 'Inter', sans-serif" }}>
      ...
      <style jsx global>{`
        ...
        /* ========================================= */
        /* 🖨️ THE ULTIMATE PREMIUM PRINT FIX         */
        /* ========================================= */
        @media print {
          body, html {
          ...
          /* 1. Aggressively hide all dashboard navigation shells */
          header, nav, footer, aside, .fixed, .sticky {
            display: none !important;
          }

          /* 2. Force the main container to behave for printing */
          main, body, html, #__next {
